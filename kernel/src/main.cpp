...
void query(Repository& Repository)
{
    while(true)
    {
        ...
        auto results = Repository.search(query,Repository::searchAccuracy::low, 5); // search with a limit of 10 results
        ...
        for (const auto &result : results)
        {
            ...
            std::cout << "Metadata: " << result.highlightedMetadata << std::endl;
...
int main()
{
    ...
    Repository Repository(repoName, repoPath, rankerModel, 
